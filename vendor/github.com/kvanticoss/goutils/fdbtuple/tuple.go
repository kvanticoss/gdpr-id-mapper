 ...
 * tuple.go
 *
 * This source file is copied (and modified) from the FoundationDB open source project.
 * The goal is to extract the tuple package and encoding logic but removing all
 * fdb specifc dependencies (including cgo)
 *
 * Copyright 2013-2018 Apple Inc. and the FoundationDB project authors,
 * Copyright 2019 Kvantic AB. (Negligible modifications & removals)
 *
